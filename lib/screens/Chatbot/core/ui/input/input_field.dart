...
import 'package:pdfeditor/screens/Chatbot/core/util/validators.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return TextSelectionTheme(
      data: const TextSelectionThemeData(
          ...
          selectionHandleColor: Color.fromARGB(255, 36, 36, 36)),
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelStyle: const TextStyle(color: Color.fromARGB(255, 52, 50, 50)),
