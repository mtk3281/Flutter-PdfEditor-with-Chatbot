...
const _primary = Color.fromARGB(208, 250, 61, 68);
const _secondary = Color.fromARGB(255, 99, 185, 255);
const _tertiary = Color.fromARGB(255, 250, 139, 187);

const _background = Color.fromARGB(255, 250, 250, 250);
const _onBackground = Color.fromARGB(255, 255, 255, 255);
const _lightest = Color.fromARGB(255, 10, 10, 10);

const _darkest = Color.fromARGB(255, 255, 255, 255);
const _disabled = Colors.grey;

const _divider = Color.fromARGB(255, 255, 255, 255);
